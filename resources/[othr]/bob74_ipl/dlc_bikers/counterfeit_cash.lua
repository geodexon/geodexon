...
BikerCounterfeit = {
    ...
    LoadDefault = function()
        ...
        BikerCounterfeit.Printer.Clear(BikerCounterfeit.Printer.basicProd)
        BikerCounterfeit.Security.Clear(BikerCounterfeit.Security.upgrade)
        BikerCounterfeit.Dryer1.Clear(BikerCounterfeit.Dryer1.open)
        BikerCounterfeit.Dryer2.Clear(BikerCounterfeit.Dryer2.on)
        BikerCounterfeit.Dryer3.Clear(BikerCounterfeit.Dryer3.on)
        BikerCounterfeit.Dryer4.Clear(BikerCounterfeit.Dryer4.on)
