...
const CITIZEN_TEMPLATES = [{
    ...
    documnetDescription: 'This is a document between two citizens of Los Santos. This document is an official legal document.',
    fields: [{
            name: 'Firstname',
            value: '',
        },
...
const TEXTS = {
    ...
    terms2: 'By signing this document you are legally bound for its context and accept every legal consequence it may generate.',
    terms3: 'Every copy of this document is equal in value of its original. Be extra careful when giving copies.',
    terms4: "Make sure you are fully aware of this document's context before you sign.",
