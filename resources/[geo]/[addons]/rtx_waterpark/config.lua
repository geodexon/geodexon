...
Config.WaterSlideWait = 10000 -- wait in miliseconds after other player can use waterslide
...
Config.WaterSlideSpeed = 1 -- we recommend to keep it as 1, maximum is 2
