...
VangConfig.Cooldown = 90 -- Time in Minutes

VangConfig.MinimumJobPolice = 4 -- Required Police

VangConfig.NumberOfBlocksInMinigame = 6 -- Number of blocks in thermite minigame

VangConfig.WeaponsToBreak = {     --weapons that can break glass
    'weapon_bat',
    'weapon_crowbar',
    'weapon_hammer',
    'weapon_golfclub',
...
VangConfig.AlarmTime = 300000 --  5 minutes


VangConfig.VitrineReward = {
    'rolex',
    'goldchain',
    '10kgoldchain',
    'diamond',
...
VangConfig.NumberOfBlocksInMinigameVar = 3 --Number of blocks in var heist

VangConfig.NumberOfItemsInVitrine = math.random(1, 3) --amount of itens that can a vitrine reward

VangConfig.PaintingReward = 'painting' --item that drop in painting

VangConfig.RequiredItemCutGlass = "cutter" -- item required to cut glass

VangConfig.PoliceCamID = 5

--Dont touch unless you know what you are doing !

VangConfig['VangelicoInside'] = {
    ['glassCutting'] = {
        ...
        rewards = {
            {
                ...
                item = 'vanDiamond',  --item that drop in glasscutting                
            },
            {
