...
function RadialMenu(params) {
    ...
    self.sectorSpace = self.radius * 0.01;
...
RadialMenu.prototype.createHolder = function () {
    ...
    self.holder.style.left =  (screen.width / 2) - (self.size / 2) + 'px';
    self.holder.style.top =  (screen.height / 2) - (self.size / 2) + 'px';
...
RadialMenu.prototype.createText = function (x, y, title) {
    ...
    text.setAttribute('font-size', self.sectorCount > 6 ? 32 - self.sectorCount + '%' : '30%');
